            ...
            if(isset($_POST['save']))
                {
                    ...
                    $checklast = mysqli_fetch_array($mysql->query("SELECT MAX(favorit_id) FROM favorites"));
                    $maxID = $checklast[0]+1;
                    ...
                    $sql = "SELECT favorites.assembly_id FROM users,assembly,favorites WHERE $idA = favorites.assembly_id AND favorites.user_id = $_COOKIE[uId]";
                    $row = mysqli_fetch_array($mysql->query($sql));
                    if(!isset($row[0])){
                    $mysql -> query("INSERT INTO `favorites` (`favorit_id`,`user_id`,`assembly_id`) VALUE('$maxID','$_COOKIE[uId]','$idA')");
                    }
                    header('Location: /profile.php');
                }
            if(isset($_POST['buy']))
                {
                    if(!isset($_GET['check-saved'])){
        ...
        <div class="shell_cfg">
            ...
            <div class="kp">
                ...
                <div class="text_kp">
                    ...
                    <p>Процессор – сердце компьютера. Чем выше частота тем быстрее обрабатываются данные,
                        а количество ядер позволяет распределить нагрузку и повысить быстродействие всей системы.</p>
                </div>
                <div class="arr_kp"><p><?=$cpu['component_name']?></p></div>
            </div>
            ...
            <div class="kp">
                ...
                <div class="text_kp">
                    ...
                    <p>Материнская плата – основа компьютера. На плату как конструктор собираются остальные комплектующие.
                        Материнская плата не отвечает за быстродействие компьютера, но отвечает за функционал.</p>
                </div>
                <div class="arr_kp"><p><?=$motherboard['component_name']?></p></div>
            </div>
            ...
            <div class="kp">
                ...
                <div class="arr_kp"><p><?=$gpu['component_name']?></p></div>
            </div>
            <?php endif;?>
            ...
            <div class="kp">
                ...
                <div class="text_kp">
                    ...
                    <p>Оперативная память – отвечает за то, с каким объемом данных в данный момент времени может работать процессор. Чем ее больше, тем быстрее работает компьютер.</p>
                </div>
                <div class="arr_kp"><p><?=$ram['component_name']?></p></div>
            </div>
            ...
            <div class="kp">
                ...
                <div class="text_kp">
                    <h3>Блок питания</h3>
                    <p>Блок питания обеспечивает током все компоненты и противостоит всем перегрузкам и скачкам сети.
                        Мощность блока питания выбирается всегда с запасом, так он дольше прослужит без пиковых нагрузок.</p>
                </div>
                <div class="arr_kp"><p><?=$power_supply['component_name']?></p></div>
            </div>
            ...
            <div class="kp">
                ...
                <div class="arr_kp"><p><?=$case['component_name']?></p></div>
            </div>
            ...
            <div class="kp">
                ...
                <div class="text_kp">
                    <h3>Кулер</h3>
                    <p>Кулер – радиатор с прикреплённым вентилятором предназначенный для охлаждения процессора. Показатель теплоотвода (TDP) кулера не должен быть меньше показателя тепловыделения (TDP) процессора.</p>
                </div>
                <div class="arr_kp"><p><?=$cooler['component_name']?></p></div>
            </div>
            ...
            <div class="kp">
                ...
                <div class="text_kp">
                    ...
                    <p>Твердотельный накопитель – это скоростное устройство для хранения данных. Его скорость работы в несколько раз быстрее обычного жесткого диска.</p>
                </div>
                <div class="arr_kp"><p><?=$ssd['component_name']?></p></div>
            </div>
            ...
            <div class="kp">
                ...
                <div class="arr_kp"><p><?=$ssd2['component_name']?></p></div>
            </div>
            <?php endif;?>
            ...
            <div class="kp">
                ...
                <div class="text_kp">
                    ...
                    <p>Жесткий диск – устройство для хранения данных, характеризуется объемом и скоростью (чтение/запись) чем больше номинальный объем тем больше данных поместится.</p>
                </div>
                <div class="arr_kp"><p><?=$hdd['component_name']?></p></div>
            </div>
            <?php endif;?>
            ...
            <div class="kp">
                ...
                <div class="arr_kp"><p><?=$dvd['component_name']?></p></div>
            </div>
            <?php endif;?>

            <?php if(isset($compId[12])):?>
            <div class="kp">
                <div class="img_kp"><img style="width: 85%; margin-left:10px;" src="assets/images/cfg-icons/configurator-11.png"></div>
                <div class="text_kp">
                    <h3>Операционная система</h3>
                    <p>Операционная система – это комплекс взаимосвязанных программ, предназначенных для управления ресурсами вычислительного устройства и организации взаимодействия с пользователем.</p>
                </div>
                <div class="arr_kp"><p><?=$assemb['os']?></p></div>
            </div>
            <?php endif;?>
            </div>
            ...
            <div class="about_assembly">
                ...
                <div class="assemblyInf"><p>Стоимость - <font style="color:rgb(200, 11, 11);font-weight: bold;;"><?=$assemb['assembly_price']?>руб.</font></p>
                <p>Номер сборки - <?=$assemb['assembly_id']?></p></div>
                <div class="assembly_img"><img class="caseImg" src="<?=$case['image']?>" alt="нет изображения"></div>
